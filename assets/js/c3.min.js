...
!(function (t, e) {
  ...
  var i = {
    ...
    chart: {
      ...
      internal: {
        fn: l.prototype,
        axis: { fn: p.prototype, internal: { fn: e.prototype } },
      },
    },
    generate: function (t) {
      return new n(t);
  ...
  (l.prototype.beforeInit = function () {}),
    ...
    (l.prototype.parseDate = function (t) {
      ...
      return (
        t instanceof Date
          ...
          : ("object" != typeof t && ("number" != typeof t || isNaN(t))) ||
            (e = new Date(+t)),
        (e && !isNaN(+e)) ||
    ...
    (n.prototype.show = function (t, e) {
      ...
      (t = n.mapToTargetIds(t)),
        ...
        (i = n.svg.selectAll(n.selectorTargets(t)))
          .transition()
          .style("display", c() ? "block" : "initial", "important")
    ...
    (l.prototype.loadConfig = function (e) {
      ...
      Object.keys(a).forEach(function (t) {
        (i = e),
          ...
          (r = (function t() {
            var e = n.shift();
            return e && i && "object" == typeof i && e in i
              ? ((i = i[e]), t())
              : e
              ? void 0
              : i;
    ...
    (l.prototype.getTotalDataSum = function () {
      ...
      var i,
        n =
          ...
          (Array.isArray(i) ? [].concat.apply([], i) : [])
            .map(function (t) {
              return t.value;
            })
            .reduce(function (t, e) {
    ...
    (l.prototype.hasDataLabel = function () {
      ...
      return (
        ...
        !("object" != typeof t.data_labels || !L(t.data_labels))
      );
    }),
    ...
    (l.prototype.getRatio = function (t, e, i) {
      ...
      return (
        e &&
          a.data.shown.call(a).length &&
          ((o = e.ratio || e.value),
          "arc" === t
            ? (o = r.hasType("gauge")
                ? (e.endAngle - e.startAngle) /
                  (Math.PI * (r.config.gauge_fullCircle ? 2 : 1))
                : ((n = r.getTotalDataSum()), e.value / n))
            : "index" === t &&
              ((n = r.getTotalPerIndex(r.axis.getId(e.id))),
              (e.ratio =
                s(e.value) && n && 0 < n[e.index] ? e.value / n[e.index] : 0),
              (o = e.ratio))),
        i && o ? 100 * o : o
      );
    }),
    ...
    (l.prototype.getXDomainPadding = function (t) {
      var e,
        ...
        o = this.isCategorized()
          ...
          : 0.01 * a;
      return (
        "object" == typeof r.axis_x_padding && L(r.axis_x_padding)
    ...
    (l.prototype.getHorizontalAxisHeight = function (t, e) {
      var i = this,
        n = i.config,
        r = 30;
      return "x" !== t || (k(e) && e ? n.subchart_axis_x_show : n.axis_x_show)
        ? "x" === t && n.axis_x_height
          ? n.axis_x_height
          : "y" !== t || n.axis_y_show
          ? "y2" !== t || n.axis_y2_show
            ? ("x" === t &&
                ...
                (r =
                  30 +
                  i.axis.getMaxTickWidth(t) *
                    Math.cos(
                      (Math.PI * (90 - Math.abs(n.axis_x_tick_rotate))) / 180
                    )),
              "y" === t &&
                n.axis_rotated &&
                ...
                (r =
                  ...
                  i.axis.getMaxTickWidth(t) *
                    Math.cos(
                      (Math.PI * (90 - Math.abs(n.axis_y_tick_rotate))) / 180
                    )),
              r +
                (i.axis.getLabelPositionById(t).isInner ? 0 : 10) +
                ("y2" === t ? -10 : 0))
            : i.rotated_padding_top
          : !n.legend_show || i.isLegendRight || i.isLegendInset
          ? 1
          : 10
        : 8;
    }),
    ...
    (l.prototype.initSubchart = function () {
      ...
      i.style("visibility", "visible"),
        ...
        (t.axes.subx = i
          ...
          .style("visibility", e.subchart_axis_x_show ? "visible" : "hidden"));
    }),
    ...
    (l.prototype.drawColorScale = function () {
      ...
      (a = o.height - c.stanford_padding.bottom - c.stanford_padding.top),
        ...
        o.colorScale
          .append("g")
          .attr("transform", "translate(0, " + c.stanford_padding.top + ")")
          .selectAll("bars")
          .data(e)
          .enter()
          .append("rect")
        ...
        o.colorScale.attr(
          "transform",
          "translate(" + (o.currentWidth - o.xForColorScale()) + ", 0)"
        );
    }),
    (l.prototype.xForColorScale = function () {
      return (
        this.config.stanford_padding.right + d(this.colorScale.node()).width
      );
    }),
    ...
    (l.prototype.getCentroid = function (t) {
      for (
        var e, i, n, r = y(t), a = 0, o = 0, s = 0, c = t.length - 1;
        s < t.length;
        c = s, s += 1
      )
        (i = t[s]),
        ...
        (i.zoom.updateDomain = function () {
          return (
            n.event &&
              ...
              (r.axis_rotated &&
              "scroll" === r.zoom_type &&
              "mousemove" === n.event.sourceEvent.type
                ? i.x.domain(n.event.transform.rescaleY(i.subX).domain())
